...
export default function Cursor(mouseOver) {
    ...
    return (
        <>
            ...
            {targetClass &&
                target === "A" || parent1 === "A" || parent2 === "A" || parent3 === "A" || parentClass === "hover-caption" || targetClass === "hover-caption" || (targetClass === "btn-2 info-btn" || targetClass === "btn-2 info-btn-2") ?
                <>
                    <div className={"dot"} id="dot" style={{ left: `${x}px`, top: `${y}px`, width: "20px", height: "20px", backgroundColor: "#fffc00", transform: "translate(-50%, -50%)", mixBlendMode: "difference" }}> </div>
                </>
                :
                target === "VIDEO" ?
                    ...
                    :
                    <div className={"dot"} id="dot" style={{ left: `${x}px`, top: `${y}px`, transform: "translate(-50%, -50%)" }}> </div>
            }
